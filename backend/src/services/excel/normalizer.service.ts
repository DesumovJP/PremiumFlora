...
export class NormalizerService {
   ...
   * Ключ - канонічна назва (без типу Rose/Spray/Garden), значення - масив варіантів
   */
  private readonly flowerNameSynonyms: Record<string, string[]> = {
    // Стандартні троянди (Rose)
    ...
    'BE Sweet': ['BE Sweet Rose'],
    'Candlelight': ['Candlelight Rose', 'Candelight'],
    'Cheetan': ['Cheetan Rose'],
    'Country Blues': ['Country Blues Rose'],
    'Creamykiss': ['Creamykiss Rose'],
    'Esperance': ['Esperance Rose'],
    'Frutteto': ['Frutteto Rose', 'Frutetto'],
    'Gotcha': ['Gotcha Rose'],
    'Heavenly': ['Heavenly Rose'],
    'Hot Spot': ['Hot Spot Rose'],
    'Kahala': ['Kahala Rose'],
    'Lola': ['Lola Rose'],
    'Luciano': ['Luciano Rose'],
    'Mandala': ['Mandala Rose'],
    'Playa Blanca': ['Playa Blanca Rose'],
    'Pomarosa': ['Pomarosa Rose'],
    'Proud': ['Proud Rose'],
    'Silantoi': ['Silantoi Rose'],
    'Swan': ['Swan Rose'],
    'Tip Top': ['Tip Top Rose'],
    'White Chocolate': ['White Chocolate Rose'],
    'Zebra': ['Zebra Rose'],

    // Spray Rose
    'Baby Flow': ['Baby Flow Spray Rose', 'Baby Flow Spray'],
    'Blue Moon': ['Blue Moon Spray Rose', 'Blue Moon Spray'],
    'BS Xapricorn': ['BS Xapricorn Spray Rose', 'BS Xapricorn Spray'],
    'Creta': ['Creta Spray Rose', 'Creta Spray'],
    'Fire UP': ['Fire UP Spray Rose', 'Fire UP Spray'],
    'Floreana': ['Floreana Spray Rose', 'Floreana Spray'],
    'Flow Pink': ['Flow Pink Spray Rose', 'Flow Pink Spray'],
    'Lavender Irishka': ['Lavender Irishka Spray Rose', 'Lavender Irishka Spray'],
    'Pink Irishka': ['Pink Irishka Spray Rose', 'Pink Irishka Spray'],
    'Polar Sensation': ['Polar Sensation Spray Rose', 'Polar Sensation Spray', 'Polar'],
    'Portrait': ['Portrait Spray Rose', 'Portrait Spray'],
    'Purple Irishka': ['Purple Irishka Spray Rose', 'Purple Irishka Spray'],
    'Royal Percelina': ['Royal Percelina Spray Rose', 'Royal Percelina Spray'],
    'Saona': ['Saona Spray Rose', 'Saona Spray'],
    'Shining Star': ['Shining Star Spray Rose', 'Shining Star Spray'],
    'Snowflake': ['Snowflake Spray Rose', 'Snowflake Spray'],
    'Star Blush': ['Star Blush Spray Rose', 'Star Blush Spray'],
    'Suspiro': ['Suspiro Spray Rose', 'Suspiro Spray'],
    'Sweet Dreams': ['Sweet Dreams Spray Rose', 'Sweet Dreams Spray'],
    'Wedding Sensation': ['Wedding Sensation Spray Rose', 'Wedding Sensation Spray'],
    'Wink Allure': ['Wink Allure Spray Rose', 'Wink Allure Spray'],

    // Garden Rose
    'Candy Xpression': ['Candy Xpression Garden Rose', 'Candy Xpression Garden', 'Candy Expression'],
    'Cream Xpression': ['Cream Xpression Garden Rose', 'Cream Xpression Garden'],
    'Dark Xpression': ['Dark Xpression Garden Rose', 'Dark Xpression Garden'],
    'Fatima': ['Fatima Gardens Rose', 'Fatima Gardens'],
    'Mandarin Xpression': ['Mandarin Xpression Garden Rose', 'Mandarin Xpression Garden'],
    'Melon Xpression': ['Melon Xpression Garden Rose', 'Melon Xpression Garden'],
    'Pink O Hara': ['Pink O Hara Garden Rose', 'Pink O Hara Garden'],
    'Pink Xpression': ['Pink Xpression Garden Rose', 'Pink Xpression Garden'],
    'Vicky': ['Vicky Gardens Rose', 'Vicky Gardens'],
    'White O Hara': ['White O Hara Garden Rose', 'White O Hara Garden'],
   ...
   * Порядок важливий: спочатку довші суфікси, потім коротші
   */
