...
export class NormalizerService {
  ...
  private readonly flowerNameSynonyms: Record<string, string[]> = {
    ...
    'Deep Purple Rose': ['Deep Purple'],
    'Brighton Rose': ['Brighton'],
    'Mondial Rose': ['Mondial', 'White Mondial'],
    'Avalanche Rose': ['Avalanche', 'Avalanche+'],
    'High Magic Rose': ['High Magic', 'Highmagic'],
    'Tiffany Rose': ['Tiffany'],
    'Sweetness Rose': ['Sweetness'],
    'BE Sweet Rose': ['BE Sweet'],
    'Candlelight Rose': ['Candlelight', 'Candelight'],
    'Cheetan Rose': ['Cheetan'],
    'Country Blues Rose': ['Country Blues'],
    'Creamykiss Rose': ['Creamykiss'],
    'Esperance Rose': ['Esperance'],
    'Frutteto Rose': ['Frutteto', 'Frutetto'],
    'Gotcha Rose': ['Gotcha'],
    'Heavenly Rose': ['Heavenly'],
    'Hot Spot Rose': ['Hot Spot'],
    'Kahala Rose': ['Kahala'],
    'Lola Rose': ['Lola'],
    'Luciano Rose': ['Luciano'],
    'Mandala Rose': ['Mandala'],
    'Playa Blanca Rose': ['Playa Blanca'],
    'Pomarosa Rose': ['Pomarosa'],
    'Proud Rose': ['Proud'],
    'Silantoi Rose': ['Silantoi'],
    'Swan Rose': ['Swan'],
    'Tip Top Rose': ['Tip Top'],
    'White Chocolate Rose': ['White Chocolate'],
    'Zebra Rose': ['Zebra'],
    ...
    'Fire UP Spray Rose': ['Fire UP Spray'],
    'Floreana Spray Rose': ['Floreana Spray'],
    'Flow Pink Spray Rose': ['Flow Pink Spray'],
    'Lavender Irishka Spray Rose': ['Lavender Irishka Spray'],
    'Pink Irishka Spray Rose': ['Pink Irishka Spray'],
    'Polar Sensation Spray Rose': ['Polar Sensation Spray', 'Polar'],
    'Portrait Spray Rose': ['Portrait Spray'],
    'Purple Irishka Spray Rose': ['Purple Irishka Spray'],
    'Royal Percelina Spray Rose': ['Royal Percelina Spray'],
    'Saona Spray Rose': ['Saona Spray'],
    'Shining Star Spray Rose': ['Shining Star Spray'],
    'Snowflake Spray Rose': ['Snowflake Spray'],
    'Star Blush Spray Rose': ['Star Blush Spray'],
    'Suspiro Spray Rose': ['Suspiro Spray'],
    'Sweet Dreams Spray Rose': ['Sweet Dreams Spray'],
    'Wedding Sensation Spray Rose': ['Wedding Sensation Spray'],
    'Wink Allure Spray Rose': ['Wink Allure Spray'],

    // Garden Rose
    'Candy Xpression Garden Rose': ['Candy Xpression Garden', 'Candy Expression'],
    'Cream Xpression Garden Rose': ['Cream Xpression Garden'],
    'Dark Xpression Garden Rose': ['Dark Xpression Garden'],
    'Fatima Gardens Rose': ['Fatima Gardens'],
    'Mandarin Xpression Garden Rose': ['Mandarin Xpression Garden'],
    'Melon Xpression Garden Rose': ['Melon Xpression Garden'],
    'Pink O Hara Garden Rose': ['Pink O Hara Garden'],
