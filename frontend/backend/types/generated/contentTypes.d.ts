...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    type: Schema.Attribute.Enumeration<['VIP', 'Regular', 'Wholesale']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFlowerFlower extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::flower.flower'>;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSupplySupply extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Supply records from Excel imports and manual entries';
    displayName: 'Supply';
    pluralName: 'supplies';
    singularName: 'supply';
  };
  ...
  attributes: {
    awb: Schema.Attribute.String;
    checksum: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateParsed: Schema.Attribute.DateTime;
    ...
    supplyErrors: Schema.Attribute.JSON;
    supplyStatus: Schema.Attribute.Enumeration<
      ['success', 'failed', 'dry-run']
    >;
    supplyWarnings: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    operationId: Schema.Attribute.String & Schema.Attribute.Unique;
    paymentDate: Schema.Attribute.DateTime;
    paymentStatus: Schema.Attribute.Enumeration<
      ['pending', 'paid', 'expected', 'cancelled']
    >;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['sale', 'writeOff']> &
      Schema.Attribute.DefaultTo<'sale'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    writeOffReason: Schema.Attribute.Enumeration<
      ['damage', 'expiry', 'adjustment', 'other']
    >;
  };
}
...
export interface ApiVariantVariant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    flower: Schema.Attribute.Relation<'manyToOne', 'api::flower.flower'>;
