      ...
      {onBackToBlog && (
        <div className="mt-12 pt-8 border-t border-slate-200">
          <div className="bg-gradient-to-br from-emerald-50 to-amber-50 rounded-2xl p-5 sm:p-8 text-center">
            <div className="inline-flex items-center gap-1 mb-1.5 sm:mb-3 px-2 py-0.5 sm:px-3 sm:py-1.5 rounded-full bg-white/80 text-emerald-700 text-[10px] sm:text-sm font-medium">
              <Sparkles className="h-2.5 w-2.5 sm:h-4 sm:w-4" />
              <span>Ще більше цікавого</span>
            </div>
            <h3 className="text-[15px] sm:text-2xl font-bold text-slate-900 mb-1 sm:mb-2">
