            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:pr-8">
              ...
              <div className="pr-6 sm:pr-0">
                <div className="flex items-center gap-1.5 mb-1 sm:mb-0.5">
                  ...
                  <span className="text-[10px] sm:text-[11px] font-semibold text-emerald-600 uppercase tracking-wide">
                    Оптова пропозиція
                  </span>
                </div>
                <h3 className="text-[14px] sm:text-[16px] font-semibold text-slate-900 leading-snug">
                  Готові до співпраці?
                </h3>
                <p className="text-[12px] sm:text-[14px] text-slate-500 mt-0.5 sm:mt-0">
