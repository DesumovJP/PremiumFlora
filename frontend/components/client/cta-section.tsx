    ...
    >
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Heading */}
          <h2 className="text-[15px] sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-slate-900 dark:text-white mb-1.5 sm:mb-4 leading-tight">
            {c.title}{' '}
            <span className="text-emerald-600 dark:text-emerald-400">{c.titleAccent}</span>
          </h2>

          {/* Subtitle */}
          <p className="text-[12px] sm:text-sm md:text-base lg:text-lg text-slate-600 dark:text-slate-400 mb-5 sm:mb-8 max-w-2xl mx-auto">
            {c.subtitle}
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            <Button
              ...
              className="group w-auto h-10 sm:h-11 md:h-14 px-5 sm:px-6 md:px-8 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-[13px] sm:text-sm md:text-base rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/25"
            >
              {c.buttonText}
