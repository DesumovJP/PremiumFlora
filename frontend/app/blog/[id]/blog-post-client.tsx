        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 pt-8 border-t border-slate-200">
            <div className="bg-gradient-to-br from-emerald-50 to-amber-50 rounded-2xl p-6 sm:p-8 text-center">
              <div className="inline-flex items-center gap-1 sm:gap-2 mb-1.5 sm:mb-3 px-2 sm:px-3 py-0.5 sm:py-1.5 rounded-full bg-white/80 text-emerald-700 text-[10px] sm:text-xs md:text-sm font-medium">
                <Sparkles className="h-2.5 w-2.5 sm:h-3 sm:w-3 md:h-4 md:w-4" />
                <span>Ще більше цікавого</span>
              </div>
              <h2 className="text-[15px] sm:text-xl md:text-2xl font-bold text-slate-900 mb-1 sm:mb-2">
